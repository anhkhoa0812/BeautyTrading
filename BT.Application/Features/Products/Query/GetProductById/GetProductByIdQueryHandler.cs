...
public class GetProductByIdQueryHandler : IRequestHandler<GetProductByIdQuery, ApiResponse>
{
    ...
    public async ValueTask<ApiResponse> Handle(GetProductByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        var response = new GetProductByIdResponse()
        {
            ...
            MachinePower = product.MachinePower,
            ControlMode = product.ControlMode,
            OutputFrequency = product.OutputFrequency,
            OutputPower = product.OutputPower,
            LedWavelength = product.LedWavelength,
            LedOutputPower = product.LedOutputPower,
            IrFrequencyConversionInfraredLight = product.IrFrequencyConversionInfraredLight,
            IrInverterInfraredOutputPower = product.IrInverterInfraredOutputPower,
            AirPumpNegativePressure = product.AirPumpNegativePressure,
            RotaryRfHandleTorqueMachineSetWeight = product.RotaryRfHandleTorqueMachineSetWeight,
            MachineNetWeight = product.MachineNetWeight,
            MachineSize = product.MachineSize,
